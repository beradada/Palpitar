$(function()
{
    ...
    albums = ['Dance Me to the End of Love','Fire Flower','돌아가자','Get Back Baby',
    'Popular Song'],
    trackNames = ['Madeleine Peyroux - Dance Me to the End of Love','Summer Salt - Fire Flower',
    '백예린 - 돌아가자',
    'Al Green - Get Back Baby',
    'Ariana Grande (ft. Mika) - Popular Song',
    'Ashes - Stellar'], 
    albumArtworks = ['_1','_2','_3','_4','_5'],
    trackUrl = ['music/Madeleine Peyroux - Dance Me to the End of Love.mp3',
    'music/Summer Salt - Fire Flower.mp3',
   'music/백예린 - 돌아가자.mp3',
    'music/Al Green - Get Back Baby.mp3',
    'Ariana Grande (ft. Mika) - Popular Song.mp3',
    'Ashes - Stellar.mp3'],
